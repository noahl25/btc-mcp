...
The platform uses MCP (Model Context Protocol) to standardize agent and tool interfaces, enabling seamless agent-to-agent interactions. Redis manages caching and ephemeral state for Lightning authentication and Docker provides isolated, deployable environments for MCP servers.
